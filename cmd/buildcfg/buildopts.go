...
func (opts *BuildOptions) AppendEnviron(env []string) []string {
...
func (opts *BuildOptions) AppendASMFlags(flags []string) []string {
	switch os := opts.Platform.OS(); os {
	case "efi":
	...
	case "amd64":
		flags = append(flags, "-D", "GOARCH_amd64", "-D", "GOAMD64_"+opts.Platform.GOAMD64())
	case "arm":
...
func (opts *BuildOptions) AppendGCFlags(flags []string) []string {
...
func (opts *BuildOptions) AppendLDFlags(flags ...string) []string {
