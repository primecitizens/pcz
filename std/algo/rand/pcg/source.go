...
func (pcg *Source) Seed(seed uint64) {
	pcg.low = seed
	pcg.high = seed // TODO: What is right?
}

// Rand32 implements rand.Core
func (pcg *Source) Rand32() uint32 {
	return uint32(pcg.Rand64() >> 32)
}

// Rand64 returns a pseudo-random 64-bit unsigned integer as a uint64.
func (pcg *Source) Rand64() uint64 {
	pcg.multiply()
	pcg.add()
